...
TemplateVM
----------
[Template Virtual Machine](/de/doc/templates/).
...
Standalone(VM)
--------------
[Standalone (Virtual Machine)](/de/doc/standalone-and-hvm/).
 ...
 * **Dedicated** DisposableVM Templates are intended neither for installing nor running software.
   Rather, they are intended for *customizing* or *configuring* software that has already been installed on the TemplateVM on which the DisposableVM Template is based (see [DisposableVM Customization](/de/doc/disposablevm-customization/).
...
HVM
---
[Hardware-assisted Virtual Machine](/de/doc/standalone-and-hvm/).
