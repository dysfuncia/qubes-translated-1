...
[Installation Guide](/de/doc/installation-guide/) for instructions and warnings
...
running the [HCL reporting tool](/de/hcl/) and sending us the results so that we
...
[Template-based scheme](/de/doc/software-update-vm/). Normally these are backed by
...
1. Download the ISO (and its signature for verification) from the
   [downloads page](/de/downloads/#qubes-live-usb-alpha).
