...
1. Follow the [steps here](/de/doc/uefi-troubleshooting/#change-installer-kernel-parameters-in-uefi) to edit the `[qubes-verbose]` section of your installer's `BOOTX64.cfg`.
...
1. Follow the [steps here](/de/doc/uefi-troubleshooting/#change-installer-kernel-parameters-in-uefi) to edit the `[qubes-verbose]` section of your installer's `xen.cfg`.
...
Whenever there is a kernel or Xen update for Qubes, you will need to follow [these steps](/de/doc/uefi-troubleshooting/#boot-device-not-recognized-after-installing) because your system is using the fallback UEFI bootloader in `[...]/EFI/BOOT` instead of directly booting to the Qubes entry under `[...]/EFI/qubes`.
...
1. Boot into [rescue mode](/de/doc/uefi-troubleshooting/#accessing-installer-rescue-mode-on-uefi).
...
You can do that just after installation (switch to `tty2` with Ctrl-Alt-F2), or by booting from installation media in [rescue mode](/de/doc/uefi-troubleshooting/#accessing-installer-rescue-mode-on-uefi).
