...
(*This page is about qrexec v3. For qrexec v2, see [here](/de/doc/qrexec2/).*)
...
For more details on the qrexec framework and protocol, see "[Qubes RPC internals](/de/doc/qrexec-internals)."
