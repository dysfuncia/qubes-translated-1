...
```
* Verify its fingerprint, set as 'trusted'. [This is described here](/de/doc/VerifyingSignatures).
...
DisposableVM, [mount the Archlinux disk in the DisposableVM](/de/doc/mount-lvm-image/), chroot to it, and then use
your archlinux-fu.
...
Dec 27 09:26:16 archlinux mount-dirs.sh[420]: /de/usr/lib/qubes/init/setup-rwdev.sh: line 16: cmp: command not found
...
Dec 27 09:26:16 archlinux mount-dirs.sh[414]: /de/dev/xvdb:
...
-- Reboot --
Dec 27 09:26:54 archlinux mount-dirs.sh[423]: /de/usr/lib/qubes/init/setup-rwdev.sh: line 16: cmp: command not found
...
Dec 27 09:26:54 archlinux mount-dirs.sh[416]: /de/dev/xvdb:
