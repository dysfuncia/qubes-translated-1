...
Please note that the above script should _not_ be added to [/rw/config/rc.local](/de/doc/config-files/)) as that is executed only _after_ the network fully started.