...
Postfix is full featured MTA (Message Transfer Agent). Here we will configure it in smarthost mode as part of common [Mutt](/de/doc/mutt/)+Postfix+[Fetchmail](/de/doc/fetchmail/) stack.
